...
- community.vmware_rest.VmwareRestModule_filters.documentation
...
from ansible_collections.community.vmware_rest.plugins.module_utils.vmware_httpapi.VmwareRestModule import VmwareRestModule
