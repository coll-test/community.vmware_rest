...
- community.vmware_rest.VmwareRestModule.documentation
...
from ansible_collections.community.vmware_rest.plugins.module_utils.vmware_httpapi.VmwareRestModule import API, VmwareRestModule
